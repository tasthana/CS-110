...
public class BankAccount {
   ...
   */
   ...
   {
      balance = 0;
      accountNumber = numberOfAccounts + ""; numberOfAccounts++;
   }
   /**
   ...
   */
   ...
   /**
   Allows you to remove money from the account if enough money is available, returns true if the transaction was completed, returns false if there was not enough money.
   ...
   */
   ...
   /**
   Mutator method to change the account number @param newAccountNumber The new account number.
   */
